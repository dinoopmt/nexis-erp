// Direct MongoDB update for quotation templates
// Run this in MongoDB shell or MongoDB Compass
// Copy and paste into mongosh terminal

db.invoicetemplates.updateMany(
  { templateName: { $in: ['Quotation_EN_with_Logo', 'Quotation_EN_without_Logo'] }, templateType: 'QUOTATION' },
  {
    $set: {
      htmlContent: `<div class="quotation-container">
      {{#withLogo}}
      <div class="header">
        ...
        <div class="left">
          ...
          <table class="document-details-table">
            ...
            <tr>
              ...
              <td class="value">{{date quotation.expiryDate 'DD/MM/YYYY'}}</td>
            </tr>
            <tr>
      ...
      <div class="terms-section">
        ...
        <ul class="terms-list">
          <li>This quotation is valid until {{date quotation.expiryDate 'DD/MM/YYYY'}}</li>
...
// Show updated count
db.invoicetemplates.find({ templateType: 'QUOTATION' }).count();
