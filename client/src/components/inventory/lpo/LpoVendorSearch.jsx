/**
 * LpoVendorSearch Component
 * Searchable vendor dropdown with selection
 */
import React, { useState, useRef, useEffect } from "react";
import { ChevronDown, X } from "lucide-react";

const LpoVendorSearch = ({ vendors, selectedVendorId, selectedVendorName, isViewMode = false, onVendorSelect }) => {
  ...
  if (!vendors || vendors.length === 0) {
    ...
    console.debug("🔄 LpoVendorSearch: Vendors loading...");
    return (
...
export default LpoVendorSearch;
