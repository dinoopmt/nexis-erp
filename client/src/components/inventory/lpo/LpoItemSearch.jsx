...
const LpoItemSearch = forwardRef(({ itemSearch, searchResults, searchLoading, onSearch, onSelectItem, onCreateProduct }, ref) => {
...
LpoItemSearch.displayName = "LpoItemSearch";
...
export default React.memo(LpoItemSearch);
